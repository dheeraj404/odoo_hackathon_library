...
async function sendVerificationEmail(email, otp) {
  try {
    const mailResponse = await mailSender(
      email,
      "Library Management System - Verify Your Email Address",
      `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
            ...
            <p style="font-size: 16px; color: #555;">
              Welcome to our Library Management System. To complete your registration, please verify your email address by entering the OTP code provided below on the verification page.
            </p>
